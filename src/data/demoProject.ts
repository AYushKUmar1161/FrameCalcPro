...
export const demoProject: Project = {
  ...
  walls: [
    { id: 'wall-north-demo', name: 'North Wall', length: 40, height: 8 },
    { id: 'wall-south-demo', name: 'South Wall', length: 40, height: 8 },
    { id: 'wall-east-demo', name: 'East Wall', length: 30, height: 8 },
    { id: 'wall-west-demo', name: 'West Wall', length: 30, height: 8 },
  ],
  openings: [
    {
      id: generateId(),
